...
class system():
    ...
    def addClock(self, 
        ...
        if not name:
            ...
            name = k
        # register new clock 
        self.devicelist[name] = f"{period},{width},{phase},U"
        return
...
if __name__ == "__main__":
    ...
    # # fh.write(f"$var wire 1 c clk0[3:0] $end\n")
    # fh.write(f"$var wire 1 c clk0 $end\n")
