...
if __name__ == "__main__":
    ...
    ls.add_device(clock(shift = 11, count = 3, name = 'clk'))
    ls.add_device(clock(shift = 9,  count = 3, name = 'clk'))
    ls.add_device(clock(55, 10, 30, None, 'clk'))
    ls.add_device(clock(55, 10, 30, 2, name = 'clk'))
    ls.add_device(clock(width = 9, shift = 10, count = 3, name = 'clk'))
    ls.add_device(clock(width = 9, shift = 10, name = 'clk'))
    ls.display()
    ls.open("./export.vcd")
    ls.run_until(200)
    ls.close()
